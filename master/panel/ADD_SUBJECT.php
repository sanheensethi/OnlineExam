...
<?php include "header.php"; ?>
      ...
      <div class="content-wrapper">
		...
		<!-- Main content -->
		<section class="content" id="addSubject">
		<div class="row">
		<!-- left column -->
		<div class="col-md-6">
		...
		<input type="text" class="form-control" id="subjectid" placeholder="Subject ID" disabled>
		</div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="box">
                ...
                <div id="message"></div>
                <div class="box-footer">
                <button type="submit" class="btn btn-info" id="addSubjectBtn">ADD SUBJECT</button>
                </div>
	...
	$(document).ready(function(){
		...
		$('#Createbtn').on('click',function(e){
			...
			$.ajax({
				url:'../ajax.php',
				type:'POST',
				data:{page:'add_subject',action:'add',courseid:"<?php echo $_GET['cid']; ?>",subjectname:$('#subjectname').val()},
		...
		$('#Updatebtn').on('click',function(e){
			...
			$.ajax({
				url:'../ajax.php',
				type:'POST',
				data:{page:'add_subject',action:'update',courseid:"<?php $_GET['cid']; ?>",subjectId:$('#subjectid').val(),subjectName:$('#subjectname').val()},
				success:function(data){
					$('#message').html(data);
					$('#subjectname').val('');
					$('#addSubject').hide();
		...
		$.ajax({
			url:'../ajax.php',
			type:'POST',
			data:{page:'add_subject',action:'fetch',courseid:course_id},
			success:function(data){
